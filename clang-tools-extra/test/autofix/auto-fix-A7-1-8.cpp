...
// CHECK: auto-fix-A7-1-8.cpp:6:22: warning: A non-type specifier shall be placed before a type specifier in a declaration
// CHECK-NEXT: std::int32_t typedef int2;
// CHECK-NEXT: ~~~~~~~~~~~~~~~~~~~~~^~~~
// CHECK-NEXT: typedef std::int32_t int2;

// CHECK: auto-fix-A7-1-8.cpp:13:21: warning: A non-type specifier shall be placed before a type specifier in a declaration
// CHECK-NEXT: void virtual inline f3();
// CHECK-NEXT: ~~~~~~~~~~~~~~~~~~~~^~~~
// CHECK-NEXT: inline virtual void f3()

// CHECK: auto-fix-A7-1-8.cpp:15:22: warning: A non-type specifier shall be placed before a type specifier in a declaration
